...
### Recommended: `@syncrolio/kv`

Use `@syncrolio/kv` to import the KV storage. This works everywhere, including in Nuxt server routes and external bundlers like [Workflow](https://useworkflow.dev):
